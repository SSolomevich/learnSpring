    ...
    <%--<br>--%>
       ...
       <%--<button type="submit"  ><img src="c:/Java/images/Коутиньо.jpg" ></button>Уравнять химическое уравнение--%>
        ...
        <table >
            ...
            <tr><td><button type="button"><p class="two">Таблица Менделеева и свойства элементов</p><p class="three">(В разработке)</p></button></td><td ></td><td><button type="button"><p class="two">Другая полезная информация</p><p class="three">(В разработке)</p></button></td></tr>
